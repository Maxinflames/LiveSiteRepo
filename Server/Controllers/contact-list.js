...
function DisplayAddPage(req, res, next) {
    res.render('index', { title: 'Add', page: 'update', contact: '', displayName: (0, index_1.UserDisplayName)(req) });
}
...
function DisplayEditPage(req, res, next) {
    ...
    contact_1.default.findById(id, {}, {}, function (err, contactToEdit) {
        ...
        res.render('index', { title: 'Edit', page: 'update', contact: contactToEdit, displayName: (0, index_1.UserDisplayName)(req) });
    });
}
