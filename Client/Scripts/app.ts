...
(function()
{
    ...
    function DisplayProjectsPage(): void {
      ...
      $("main").append(
        `<img src="./Assets/Images/Project.PNG" alt="This Project"  width="700" height="400">`
      );
      $("main")
    ...
    function DisplayAboutPage(): void {
      ...
      $("main").append(
        `<img src="./Assets/Images/Me1.jpg" alt="Solo Picture"  width="300" height="400">  <img src="./Assets/Images/Me2.jpg" alt="Picture with Little Sister"  width="300" height="400">`
      );
      $("main")
        .append(`<p class="h7 mt-3 ">-------------------------------------------------------------------------------------------------<br>
